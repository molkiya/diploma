...
def read_data(features_path, classes_path, edges_path):
...
def get_data(features_path, classes_path, edges_path, only_labeled = True):
    ...
    #read datasets
    (df_features, df_classes, df_edges) = read_data(features_path, classes_path, edges_path)
...
def preprocessing_pipeline(features_path, classes_path, edges_path, last_train_timestep, last_test_timestep, only_labeled = True):
    ...
    #get data
    df = get_data(features_path=features_path, classes_path=classes_path, edges_path=edges_path, only_labeled=only_labeled)
